...
public abstract class MessageAttribute implements MessageAttributeInterface {
	...
	public MessageAttribute(final MessageAttributeType type) {
		setType(type);
	}

	public void setType(final MessageAttributeType type) {
		this.type = type;
	}
	...
	public static int typeToInteger(final MessageAttributeType type) {
	...
	public static MessageAttributeType intToType(final long type) {
	...
	public static MessageAttribute parseCommonHeader(final byte[] data) throws MessageAttributeParsingException {
		try {
